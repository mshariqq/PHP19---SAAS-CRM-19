...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card-body">
        <div>
            <h4 class="mb-3 f-w-600"><?php echo e(__('Register')); ?>🙂</h4>
        </div>
        ...
        <div class="custom-login-form">
            <?php echo e(Form::open(['route' => 'register', 'method' => 'post', 'id' => 'loginForm'])); ?>
                ...
                <div class="form-group mb-3">
                    <label class="form-label "> <i class="fa fa-user mt-1" aria-hidden="true"></i> <?php echo e(__('Full Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group mb-3">
                    <label class="form-label "> <i class="fa fa-envelope mt-1" aria-hidden="true"></i> <?php echo e(__('Email')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group mb-3">
                    <label class="form-label "> <i class="fa fa-lock mt-1" aria-hidden="true"></i> <?php echo e(__('Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label class="form-control-label "> <i class="fa fa-lock mt-1" aria-hidden="true"></i> <?php echo e(__('Confirm password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <?php if(\App\Models\Utility::getValByName('SIGNUP') == 'on'): ?>
                <p class="text-center"><?php echo e(__('Already have an account?')); ?> <a href="<?php echo e(url('login/'."$lang")); ?>" tabindex="0"><?php echo e(__('Login')); ?></a></p>
            <?php endif; ?>
    </div>
    </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shari\ICU\SAAS CRM 19\code\resources\views/auth/register.blade.php ENDPATH**/ ?>